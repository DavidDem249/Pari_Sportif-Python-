...
class FenetreAcceuil:
	...
	def __init__(self, master):
		...
		self.txtPro['value'] = (listeEquipe[self.equipe01],listeEquipe[self.equipe02],"match nul")
		...
		self.txtRes['value'] = ("","Victoire","Egalité")
	...
	def valider(self):
		...
		# nomEquipe1 = listeEquipe[equipe01]
		# nomEquipe2 = listeEquipe[equipe02]
